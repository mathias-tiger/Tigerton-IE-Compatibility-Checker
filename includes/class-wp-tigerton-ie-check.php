 ...
 * @subpackage Wp_wp_tigerton_ie_check/includes
 */
...
class Wp_tigerton_ie_check {
    ...
    private function define_public_hooks() {
        ...
        $this->loader->add_action( 'init', $plugin_public,'wp_tigerton_ie_newuser_cookie');
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wp_tigerton-ie-check_Loader    Orchestrates the hooks of the plugin.
	 */
